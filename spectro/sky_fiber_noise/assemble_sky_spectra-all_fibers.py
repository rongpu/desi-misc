...
if stack_type == 'same_night':
    spec.write('/global/cfs/cdirs/desicollab/users/rongpu/data/spectro/sky_spectra/sky_spectra_same_night_20240212-all_fibers.fits', overwrite=False)
elif stack_type == 'different nights 3 months':
    spec.write('/global/cfs/cdirs/desicollab/users/rongpu/data/spectro/sky_spectra/sky_spectra_different_nights_202401_202403-all_fibers.fits', overwrite=False)
