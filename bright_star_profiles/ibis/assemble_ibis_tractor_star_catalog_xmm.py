...
fns = glob.glob('/global/cfs/cdirs/cosmo/work/legacysurvey/ibis/reductions/ibis4/tractor/*/tractor-*.fits')
print(len(fns))
fns.sort()
print(len(fns))
...
cat.write('/pscratch/sd/r/rongpu/ibis/tractor_cosmos_stars.fits')
