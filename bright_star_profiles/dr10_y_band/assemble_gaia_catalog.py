...
gaia_output_path = '/global/cfs/cdirs/desi/users/rongpu/misc/gaia_dr2_for_dr10_Y_band_halo.fits'

cat = Table(fitsio.read('/global/cscratch1/sd/rongpu/temp/dr10_Y_band_photom_gaia_dr2-trim.fits', columns=['ra', 'dec']))
...
coeffs = dict(
    Y = [0.5339998564, -1.0582543748, 0.1794633041, 0.0150190495,
        -0.0878825262, 0.0446212280, -0.0086010174, 0.0005798400],)
