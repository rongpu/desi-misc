...
cat_xmm.write('/global/cfs/cdirs/desicollab/users/rongpu/data/ibis/deep_field_subsets/subset-25.0/tractor_xmm.fits')

mask = cat['ra']>100
cat_cosmos = cat[mask].copy()
print('COSMOS', len(cat_cosmos))
cat_cosmos.rename_column('ls_id_dr11', 'ibis_id')
cat_cosmos.write('/global/cfs/cdirs/desicollab/users/rongpu/data/ibis/deep_field_subsets/subset-25.0/tractor_cosmos.fits')
