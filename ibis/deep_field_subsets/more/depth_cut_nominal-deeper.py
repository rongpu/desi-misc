...
grid.write(f'/global/cfs/cdirs/desicollab/users/rongpu/data/ibis/deep_field_subsets/misc/depth_and_efftime_subset_25.2_{field}_{band}.fits', overwrite=True)

ccd = ccd[ccds_to_keep]
ccd.write(f'/global/cfs/cdirs/desicollab/users/rongpu/data/ibis/deep_field_subsets/misc/survey-ccds-ibis-dr1-subset_25.2_{field}_{band}.fits', overwrite=True)
