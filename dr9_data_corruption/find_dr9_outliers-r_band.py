# Same as find_dr9_outliers-r_band.ipynb
...
def find_outliers(sweep_fn):
    ...
    tmp = fitsio.read(sweep_fn, columns=['FLUX_R'])
...
def main():
    ...
    cat = vstack(res)
    cat.write('/global/cfs/cdirs/desi/users/rongpu/dr9/misc/dr9_south_g_band_outliers.fits')
