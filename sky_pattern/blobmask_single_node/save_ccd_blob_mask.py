...
skyrun = Table.read('/global/cscratch1/sd/rongpu/temp/skyrunsgoodcountexpnumv48dr8_random_subset.fits')

# Remove the exposures that have already been processed
skyrun_less = Table.read('/global/cscratch1/sd/rongpu/temp/skyrunsgoodcountexpnumv48dr8_less.fits')
mask = np.in1d(skyrun['expnum'], skyrun_less['expnum'])
skyrun = skyrun[~mask]

# All z-band exposures have been processed
...
###############################################
# Only run this on a subset due to time limit
expnum_list = expnum_list[:200]
###############################################
