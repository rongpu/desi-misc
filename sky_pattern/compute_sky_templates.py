...
output_dir = '/global/cscratch1/sd/rongpu/dr9dev/sky_pattern/sky_templates_v1'
...
# ##################### Downsampling due to time limit #########################
# run_list = run_list[:30]
run_list = run_list[60:90]
# run_list = run_list[90:120]
# ##############################################################################
