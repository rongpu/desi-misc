...
output_dir = '/global/cscratch1/sd/rongpu/dr9dev/sky_pattern/sky_templates_v1_debug'
...
def compute_smooth_sky(run, plot_q=False, diagnostic_touch=True):
    ...
    if diagnostic_touch:
        Path('/global/u2/r/rongpu/temp/debug/sky_template_status/'+os.path.basename(output_path)).touch()
        Path('/global/u2/r/rongpu/temp/debug/sky_template_being_written/'+os.path.basename(output_path)).touch()
    ...
    os.remove('/global/u2/r/rongpu/temp/debug/sky_template_being_written/'+os.path.basename(output_path))
