...
def patch_n10(run):
    ...
    img_all_path = os.path.join('/global/cscratch1/sd/rongpu/dr9dev/sky_pattern/sky_templates_patched/sky_template_{}_{}.fits.fz'.format(band, run))
    img_n10_path = os.path.join('/global/cscratch1/sd/rongpu/dr9dev/sky_pattern/sky_templates_n10/sky_template_{}_{}.fits.fz'.format(band, run))
    img_all_new_path = os.path.join('/global/cscratch1/sd/rongpu/dr9dev/sky_pattern/sky_templates_final/sky_template_{}_{}.fits.fz'.format(band, run))
    ...
    for ccdnum in ccdnum_list:
        ...
        if ccdname=='N10':
            img = fitsio.read(img_n10_path, ext=ccdname)
        else:
            try:
