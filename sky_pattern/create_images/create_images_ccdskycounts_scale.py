...
plot_dir = '/global/cfs/cdirs/desi/www/users/rongpu/plots/dr9dev/sky_pattern/sky_templates_v1/ccdskycounts_scale'
...
def make_plots(sky_path):
    ...
    for index in skyrun_idx:
        ...
        plot_path = os.path.join(plot_dir, band, '{}_{}_image_{}_ccdskycounts.png'.format(band, run, expnum))
