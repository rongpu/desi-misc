...
def make_plots(expnum):
    ...
    skyscale_index = np.where(skyscale['expnum']==expnum)[0][0]
    if (skyscale['run'][skyscale_index]==-1) or (skyscale['PLPROCID'][skyscale_index]==''):
        return None
    medianskyscale = skyscale['skyscale'][skyscale_index]
