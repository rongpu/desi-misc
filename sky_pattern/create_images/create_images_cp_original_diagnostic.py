...
run_list = [16, 20, 31, 34, 126, 249, 342, 345, 369, 426, 431, 457, 459, 518, 553, 592, 703, 706, 736, 791, 839, 855, 879]
...
plot_dir = '/global/cfs/cdirs/desi/www/users/rongpu/plots/dr9dev/sky_pattern/sky_templates_v2/original_CP_images_diagnostic'
...
def main():
    ...
    with Pool(processes=n_processes) as pool:
        res = pool.map(make_plots, np.arange(len(skyrun)))
