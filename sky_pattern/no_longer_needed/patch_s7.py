...
def patch_s7(run):
    ...
    img_all_path = os.path.join('/global/cscratch1/sd/rongpu/dr9dev/sky_pattern/sky_templates/sky_template_{}_{}.fits.fz'.format(band, run))
    ...
    img_all_new_path = os.path.join('/global/cscratch1/sd/rongpu/dr9dev/sky_pattern/sky_templates_patched/sky_template_{}_{}.fits.fz'.format(band, run))
