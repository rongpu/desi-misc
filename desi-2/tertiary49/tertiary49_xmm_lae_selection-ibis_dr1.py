...
ibis = Table(fitsio.read('/global/cfs/cdirs/desicollab/users/rongpu/data/ibis/deep_fields/tractor_xmm.fits'))
hsc_deep = Table(fitsio.read('/global/cfs/cdirs/desicollab/users/rongpu/data/ibis/deep_fields/tractor_xmm-hsc_deep.fits'))
hsc_wide = Table(fitsio.read('/global/cfs/cdirs/desicollab/users/rongpu/data/ibis/deep_fields/tractor_xmm-hsc_wide.fits'))
...
cat = cat[mask]
print(len(cat))
# cat.write('/global/cfs/cdirs/desicollab/users/rongpu/data/desi2/xmm_highz/tertiary49_xmm_lae_targets-ibis_dr1.fits', overwrite=False)
