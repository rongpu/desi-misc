...
image_dir_original = '/global/cfs/cdirs/cosmo/staging/decam/CP-LG9'
image_dir = '/global/cscratch1/sd/rongpu/dr9dev/pupil_pattern/pupil_corrected_images/'
...
plot_dir = '/global/cfs/cdirs/desi/users/rongpu/plots/dr9dev/pupil_pattern/lg_pupil_corrected/'
...
def make_plots(image_path):
    ...
    for ccdnum in ccdnum_list_for_median_sky:
        ...
        # Use the original image for color scale
        image_path_original = os.path.join(image_dir_original, image_filename)
        img = fits.getdata(image_path_original, extname=ccdname)
