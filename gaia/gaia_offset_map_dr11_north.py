...
cat = Table(fitsio.read('/global/cfs/cdirs/desi/users/rongpu/data/gaia_dr3/misc/gaia_dr11_north_offsets.fits'))
...
for nside in [64, 128, 256]:
    ...
    hp_table.write('/global/cfs/cdirs/desi/users/rongpu/data/gaia_dr3/misc/gaia_xp_dr11_north_offset_maps_{}.fits'.format(nside), overwrite=True)
