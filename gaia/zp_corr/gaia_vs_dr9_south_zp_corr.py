...
fns = sorted(glob.glob('/global/cfs/cdirs/desi/users/rongpu/data/gaia_dr3/dr9_south_cross_match_zp_corr/*-gaia.fits'))
...
new.write('/global/cfs/cdirs/desi/users/rongpu/data/gaia_dr3/misc/gaia_dr9_south_offsets_zp_corr.fits')
