...
for field in ['north', 'south']:
    ...
    output_dir = '/global/cfs/cdirs/desi/users/rongpu/data/gaia_dr3/dr11_{}_cross_match'.format(field)

    sweep_fns = sorted(glob.glob('/global/cfs/cdirs/cosmo/data/legacysurvey/dr11/{}/sweep/11.0/sweep-*.fits'.format(field)))
