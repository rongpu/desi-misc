...
output_dir = '/global/cfs/cdirs/desi/users/rongpu/data/gaia_dr3/dr9_south_cross_match'

sweep_fns = sorted(glob.glob('/global/cfs/cdirs/cosmo/data/legacysurvey/dr9/south/sweep/9.0/sweep-*.fits'))
