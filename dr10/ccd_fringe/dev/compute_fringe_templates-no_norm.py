...
output_path = os.path.join(output_dir, 'DECam_z_frg_{}_CCD{}_raw_no_norm.fits'.format(ccdname, str(ccdnum).zfill(2)))
...
plt.savefig(os.path.join(plot_dir, 'fringe_new_{}_no_norm.png'.format(ccdnum)))
plt.close()
...
plt.savefig(os.path.join(plot_dir, 'fringe_new_{}_smooth_no_norm.png'.format(ccdnum)))
plt.close()
