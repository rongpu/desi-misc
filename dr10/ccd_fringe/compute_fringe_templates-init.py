...
plot_dir = '/global/cfs/cdirs/desi/users/rongpu/dr10dev/fringe/plots-init'
output_dir = '/global/cfs/cdirs/desi/users/rongpu/dr10dev/fringe/data/fringe_templates_init'
