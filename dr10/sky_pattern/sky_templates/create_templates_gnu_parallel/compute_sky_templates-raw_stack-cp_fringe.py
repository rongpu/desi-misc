# Compute templates for runs with CP fringe correction
...
# Apply ccd_cuts but ignore zpt_small, too_many_bad_ccds and DEPTH_CUT
ccd_cuts_bits = np.arange(17)
bits_to_ignore = [6, 14, 15]
