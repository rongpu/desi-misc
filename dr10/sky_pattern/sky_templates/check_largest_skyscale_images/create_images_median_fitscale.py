...
def make_plots(expnum):
    ...
    for ii, ccdnum in enumerate(ccdnum_list):
        ...
        img = img - sky_dict[ccdname] * medianskyscale
        ...
        img = img/ccd['exptime'][ccd_index]*100.
...
for run in [426, 427, 428]:
    print(run)

    image_dir = '/global/project/projectdirs/cosmo/staging'
    # surveyccd_path = '/global/cfs/cdirs/desi/users/rongpu/dr10dev/sky_pattern/survey-ccds-decam-dr10-v2-z_only.fits'
    ...
    # plot_dir = '/global/cfs/cdirs/desi/users/rongpu/plots/dr10dev/sky_templates/median_fit_scale'
    ...
    # highest skyscale exposures
    expnum_list = [967902, 979358, 979364, 980630, 990988, 990999, 991002, 991011, 991017, 991020, 991023, 991043, 991045, 991047, 991053, 991079, 991081, 991085, 991087, 1002031, 1002037, 1002039]
    mask = np.in1d(skyrun['expnum'], expnum_list)
    skyrun = skyrun[mask]
    ...
    ccd_columns = ['image_filename', 'expnum', 'ccdname', 'ccdskycounts', 'ccd_cuts', 'plver', 'exptime']
