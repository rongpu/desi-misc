...
blob_dir = '/global/cfs/cdirs/desi/users/rongpu/dr10dev/decam_ccd_blob_mask/blob_mask'
blob_dir_dr9 = '/global/cfs/cdirs/desi/users/rongpu/dr9/decam_ccd_blob_mask/blob_mask'

plot_dir = '/global/cfs/cdirs/desi/users/rongpu/dr10dev/decam_ccd_blob_mask/plots/focal_plane'
...
def blobmask_plot(image_filename, figsize=(26, 24), binsize=10, median=True,
    ...
    blob_path = os.path.join(blob_dir, img_filename_base+'-blobmask.npz')
    # print(blob_path)

    if not os.path.isfile(blob_path):
        print('File does not exist in DR10:', blob_path)
        blob_path = os.path.join(blob_dir_dr9, img_filename_base+'-blobmask.npz')
        use_dr9 = True
        if not os.path.isfile(blob_path):
...
img_fns_all = np.unique(ccd['image_filename'])
img_fns = np.random.choice(img_fns_all, size=320, replace=False)
# print(img_fns)
