...
skyrun = Table.read('/global/cfs/cdirs/desicollab/users/rongpu/data/dr11dev/skyrunsdr11-v3-rearrange-dr9_added.fits')
...
for run in run_list:
    ...
    ccd1 = ccd[mask].copy()
    ccd1.write('/global/cfs/cdirs/desi/users/rongpu/data/dr11dev/sky_pattern/survey_ccds_in_runs/survey-ccds-decam-dr11-merged-incl-early-run_{}.fits'.format(run), overwrite=True)
