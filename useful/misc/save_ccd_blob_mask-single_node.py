...
surveyccd_path = '/global/cscratch1/sd/rongpu/temp/survey-ccds-decam-dr9-remaining.fits'
# output_dir = '/global/cscratch1/sd/rongpu/fringe/decam_ccd_blob_mask'
output_dir = '/global/cfs/cdirs/desi/users/rongpu/dr9/decam_ccd_blob_mask'
# plot_dir = '/global/cfs/cdirs/desi/users/rongpu/dr9/decam_ccd_blob_mask/plots'
plot_dir = '/global/cscratch1/sd/rongpu/temp/blob_plots'
...
ccd_columns = ['image_filename', 'image_hdu', 'expnum',  'ra', 'dec', 'ccdraoff', 'ccddecoff']
ccd = Table(fitsio.read(surveyccd_path, columns=ccd_columns))

# ########################################
# # Only run this on a small subset of exposures
# skyrun = Table.read('/global/cscratch1/sd/rongpu/temp/skyrunsgoodcountexpnumv48dr8_less_than_50_exposures.fits')
...
def save_ccd_blob_mask(expnum):
    ...
    plot_path = os.path.join(plot_dir, img_filename_base+'-blobmask')
