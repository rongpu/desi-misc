...
def make_plots(image_fn_lg):
    ...
    for ii, ccdnum in enumerate(ccdnum_list):
        ...
        # fig = plt.imshow(img.T, cmap='gray', vmin=-bestfit_intercept/12, vmax=bestfit_intercept/12, 
        fig = plt.imshow(img.T, cmap='seismic', vmin=-bestfit_intercept/10, vmax=bestfit_intercept/10, 
