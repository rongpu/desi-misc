...
plot_dir = '/global/cfs/cdirs/desi/users/rongpu/plots/dr9dev/pupil_pattern/test/'
...
def make_plots(image_path):
    ...
    plot_path = os.path.join(plot_dir, image_path)
    ...
    for ii, ccdnum in enumerate(ccdnum_list):
        ...
        fig = plt.imshow(img.T, cmap='seismic', vmin=-1, vmax=1,
