...
template_dir = '/global/cfs/cdirs/cosmo/data/legacysurvey/dr9/calib/sky_pattern/sky_templates'
...
fn_list = glob.glob(os.path.join(template_dir, '*.fits.fz'))
...
plot_dir = '/pscratch/sd/r/rongpu/tmp/sky_templates_dr9'
