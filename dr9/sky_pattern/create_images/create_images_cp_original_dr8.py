...
plot_dir = '/global/cfs/cdirs/desi/www/users/rongpu/plots/dr9dev/sky_pattern/sky_templates_v2/original_CP_images_dr8'
...
def make_plots(expnum):
    ...
    plot_path = os.path.join(plot_dir, band, '{}_{}_image_{}_dr8.png'.format(band, run, expnum))
